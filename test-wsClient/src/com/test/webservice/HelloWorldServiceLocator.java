...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.test.webservice.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost/test-ws/services/HelloWorld";
    ...
    public com.test.webservice.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.test.webservice.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.test.webservice.HelloWorldSoapBindingStub _stub = new com.test.webservice.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.test.webservice.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.test.webservice.HelloWorldSoapBindingStub _stub = new com.test.webservice.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.test.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.test.com", "HelloWorld"));
        }
